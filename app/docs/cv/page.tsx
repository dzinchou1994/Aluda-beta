          ...
          <div className="flex justify-end items-center mb-6">
            <div className="flex flex-wrap gap-3">
              ...
              >
                ...
                <span className="hidden sm:inline">გადმოწერა</span>
                  ...
                  <div className="flex items-center space-x-1">
                    <div className="flex items-center rounded-lg border border-slate-200 overflow-hidden">
                      <button
                        ...
                        className="px-1.5 py-0.5 text-slate-700 hover:bg-slate-100"
                        aria-label="Zoom out"
                      >
                        −
                      </button>
                    ...
                    <button
                      ...
                      className="flex items-center space-x-1.5 px-2.5 py-1 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-xs"
                    >
